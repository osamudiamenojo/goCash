...
public class Template {
    ...
    public static String passwordResetEmail(String name, String token) {
        return "<div style=\"font-family: Helvetica, Arial, sans-serif; font-size: 16px; margin: 0; color: #0b0c0c;\">\n" +
                ...
                "<a href=\"" + Template.passwordResetLink(token) + "\">" + Template.passwordResetLink(token) + "</a>\n" +
                "</p>\n" +
    ...
    public static String passwordResetLink(String token) {
        return   "http://localhost:8088/api/v1/GoCash/PasswordReset?token=" + token;
    }
}
